...
app.post('/books/insertbook', (req, res) => {
    ...
    const query = `INSERT INTO book (title, author, pages, launch_date) VALUES ('${title}', '${author}', ${pages}, '${launch_date}')`;
...
app.post('/book/updatebook', (req, res) => {
    ...
    const sql = `UPDATE book 
                SET title = '${title}', author = '${author}', pages = ${pages}, launch_date = '${launch_date}' 
                WHERE id = ${id}`;
